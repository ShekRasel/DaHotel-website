      ...
      <div className="  mt-24 flex flex-col  md:flex-row  px-4 xl:px-24 2xl:px-48 justify-between  gap-14 2xl:gap-24">
        ...
        <div className="font-roboto tracking-wide md:w-1/2">
          ...
          <h1 className="text-4xl 2xl:text-5xl font-semibold text-[#2C4549] mt-8">
            Most Safe & Rated Hotel
          </h1>
          <h1 className="text-4xl 2xl:text-5xl italic text-[#2C4549] mt-3">
            In London.
          </h1>
          ...
          <h1 className="mt-8 text-[#2C4549] flex items-center gap-2">
            <span>
              <IoCheckmark />
            </span>
            24 Month / 24,000km Nationwide Warranty monotone
          </h1>
          <h1 className="mt-1 text-[#2C4549] flex items-center gap-2">
            <span>
              <IoCheckmark />
            </span>
