      ...
      <div className="flex justify-center">
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <h1 className={`text-center text-4xl md:text-6xl xl:text-8xl text-white font-bold absolute top-1/2 ${index === 1 && 'font-tourney text-yellow-600'} ${index === 2 && 'font-train'} ${index === 3 && 'font-train text-blue-400'}`}>
              {service.head}
            </h1>
          </div>
        ))}
