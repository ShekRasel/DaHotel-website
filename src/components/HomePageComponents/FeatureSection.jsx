    ...
    <div className={`px-4 md:px-14 mt-[620px] ${marginT} lg:mt-0 lg:pt-52 lg:flex lg:px-8 xl:px-24 2xl:px-44 lg:gap-10 2xl:gap-28`}>
      ...
      <div className='grid md:grid-cols-2 gap-8 mt-14 lg:mt-0 lg:w-3/4 xl:w-3/5'>
        {features.map((feature,index)=>(
          <div className='border p-6 2xl:p-10  hover:border-white hover:shadow-md transition-all duration-1000 ease-out' key={index}>
            <img src={feature.icon} alt="" />
            <h1 className='text-[#2C4549] text-2xl mt-3 font-semibold'>{feature.header}</h1>
            <p className='text-gray-500 mt-3 font-firsSans'>{feature.description}</p>
          </div>
        ))}
      </div>
    </div>
